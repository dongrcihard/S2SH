...
<head>
    ...
    <script type='text/javascript' src='javascript/amain.js'></script>
</head>
<body onload="init();">
    ...
    <tr>
        ...
        <td width="165" rowspan="2">
            <div align="left"><a href="http://www.crazyit.org">
                <img src="http://www.crazyit.org/logo.jpg" alt="疯狂Java联盟" border="0"/></a></div>
        </td>
    </tr>
    <tr>
        <td height="15">
            <div align="center" class="title">
                如果需要开发高档的Ajax+Java EE应用，请登录<a href="http://www.crazyit.org">http://www.crazyit.org</a>联系
            </div>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td>
            ...
            <table width="80%" border="0" align="center" cellspacing="1" bgcolor="#ccc">
                ...
                <tr bgcolor="#eee">
                    <td colspan="4">
                        <div id="failAndOwnerTitle" class="mytitle">所有流拍的物品</div>
                    </td>
                </tr>
                <tr>
                    <th>物品名</th>
    ...
    <tr>
        <td>
            ...
            <table width="80%" border="0" align="center" cellspacing="1" bgcolor="#ccc">
                ...
                <tr bgcolor="#eee">
                    <td colspan="4">
                        <div class="mytitle">您赢取的所有物品</div>
                    </td>
                </tr>
                <tr>
                    <th>物品名</th>
    ...
    <tr>
        ...
        <td width="79%" valign="top">
            ...
            <table width="96%" border="0" align="left" cellspacing="1" bgcolor="#ccc">
                ...
                <tr bgcolor="#eee">
                    <td colspan="5">
                        <div class="mytitle">当前种类是：
                            <span id="bidCatalog"></span></div>
                    </td>
                </tr>
                <tr>
                    <th>物品名</th>
...
<table width="780" border="0" align="center"
    ...
    <tr height="5">
        <td colspan="3" background="image/auction/bottom.jpg"></td>
    </tr>
</table>
</body>
</html>